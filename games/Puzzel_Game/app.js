/* All Javascript written by Jeffrey B. Madden 2017-2021 */
...
(function() {
    ...
    Game.prototype = {
       ...
       startMoving : function() {
          ...
          else { console.log("start Moving, but failed check") ; }
          } ,
       ...
       userMove : function( event ) {
          ...
          switch ( event.keyCode )
             {
             case 37 : self.moveHorizontal(false) ; break ; /* left */
             case 39 : self.moveHorizontal(true) ; break ; /* right */
             case 40 : self.moveDown() ; break ; /* down */
             case 78 : self.rotateBlock(false) ; break ; /* n (counter-clockwise) */
             case 77 : self.rotateBlock(true) ; break ; /* m (clockwise) */
